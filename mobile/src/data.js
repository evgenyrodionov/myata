...
export const places = [
  {
    ...
    highlights: [
      {
        title: 'VIP-комнаты с PS4',
        photoId: 'e7c13550-1ed4-4342-bd1a-148a614fb3a3',
      },
      {
        title: 'Lounge зона',
        photoId: '8bb4a913-7fc2-43f1-a2be-84f75e258dc7',
      },
      {
        title: 'Настольные игры',
        photoId: '335eac28-e0b7-438f-b3e5-b6ef0a6a26ca',
      },
      {
        title: 'Европейская кухня от партнеров',
        photoId: 'b8ff9b75-da7b-400f-8051-b81e78cb9538',
      },
      {
        title: 'Бизнес-ланчи',
        photoId: '102cbf9c-a7fa-48a9-bc2a-14b7fa943b81',
      },
      {
        title: 'Безалкогольные напитки',
        photoId: 'a6a4542d-5b3a-43d8-8a04-bbf4c77e17f7',
      },
      {
        title: 'Закуски',
        photoId: '029de189-8115-4504-b6b5-f4d35712120a',
      },
      {
        title: 'Десерты',
        photoId: 'c5f0dbd6-427e-48b6-ac13-76e8107c3952',
      },
    ],
    photos: [
